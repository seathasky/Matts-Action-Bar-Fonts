...
function MABF:BuildUIFeaturesBlizzardPage(opts)
    ...
    buffDebuffRightClickCameraDesc:SetPoint("RIGHT", pageUIFeatures, "RIGHT", -24, 0)
    buffDebuffRightClickCameraDesc:SetJustifyH("LEFT")
    buffDebuffRightClickCameraDesc:SetWordWrap(true)
    buffDebuffRightClickCameraDesc:SetText("|cff888888Right-click passes through for camera drag. Hold Ctrl + Right Click to remove buffs.|r")
