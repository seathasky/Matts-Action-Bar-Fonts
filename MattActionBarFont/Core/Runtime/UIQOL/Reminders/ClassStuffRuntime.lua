...
do
    ...
    local function ShouldEvaluateClassStuffReminder()
        ...
        if db.classHideWhileMounted and IsPlayerMounted() then
            return false
        end
    ...
    function MABF:SetupClassStuffReminder()
        ...
        if self._classStuffReminderTicker and self._classStuffReminderTicker.Cancel then
            self._classStuffReminderTicker:Cancel()
            self._classStuffReminderTicker = nil
        end
        ...
        if C_Timer and C_Timer.NewTicker then
            self._classStuffReminderTicker = C_Timer.NewTicker(1.0, function()
                SyncDungeonCombatStarted()
                if MABF and MABF.UpdateClassStuffReminder then
                    MABF:UpdateClassStuffReminder()
                end
