...
MABF.defaults = {
    ...
    petHideWhileMounted = false, -- Hide pet reminders while mounted
    ...
    trackConsumables  = false,  -- Track missing consumable reminders
    warnConsumableFood = true, -- Track missing food buff
    warnConsumableFlask = true, -- Track missing flask/phial buff
    warnConsumableOil = true, -- Track missing weapon oil
    warnConsumableAugmentRune = true, -- Track missing augment rune buff
    ...
    consumablesHideWhileMounted = false, -- Hide consumables reminder while mounted
    ...
    classHideWhileMounted = false, -- Hide class reminders while mounted
    ...
    buffsHideWhileMounted = false, -- Hide buff reminder while mounted
